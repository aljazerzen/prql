...
fn convert_options(o: CompileOptions) -> Result<prqlc_main::Options, prqlc_main::ErrorMessages> {
    let target = Target::from_str(&o.target).map_err(|e| prqlc_main::downcast(e.into()))?;
