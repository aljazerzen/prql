...
[PRQL `std`](https://github.com/PRQL/prql/blob/main/prqlc/crates/main/src/semantic/std.prql):

```admonish note
PRQL 0.9.0 has started supporting different DB implementations for standard library functions.
The source is the [`std.sql`](https://github.com/PRQL/prql/blob/main/prqlc/crates/main/src/sql/std.sql.prql).
```

```prql no-eval
{{#include ../../../../../prqlc/crates/main/src/semantic/std.prql}}
```
