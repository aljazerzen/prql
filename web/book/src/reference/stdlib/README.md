...
[PRQL `std`](https://github.com/PRQL/prql/blob/main/prql-compiler/crates/prql-compiler/src/semantic/std.prql):

```admonish note
PRQL 0.9.0 has started supporting different DB implementations for standard library functions.
The source is the [`std.sql`](https://github.com/PRQL/prql/blob/main/prql-compiler/crates/prql-compiler/src/sql/std.sql.prql).
```

```prql no-eval
{{#include ../../../../../prql-compiler/crates/prql-compiler/src/semantic/std.prql}}
```
