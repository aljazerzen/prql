var hljs = (function () {
  ...
  function we(e) {
    ...
    return {
      ...
      keywords: i,
      exports: { PARAMS_CONTAINS: p, CLASS_REFERENCE: f },
      illegal: /#(?![$_A-z])/,
      contains: [
        ...
        E,
        { beginKeywords: "while if case catch for" },
        {
          begin:
            "\\b(?!function)" +
            e.UNDERSCORE_IDENT_RE +
  ...
  var Ue = Object.freeze({
    ...
    grmr_cpp: (e) => {
      const n = e.regex,
        ...
        i =
          ...
          n.optional("<[^<>]+>") +
          ")",
        r = { className: "type", begin: "\\b[a-z\\d_]*_t\\b" },
        s = {
          className: "string",
          variants: [
            {
    ...
    grmr_less: (e) => {
      const n = te(e),
        ...
        i = [],
        r = [],
        s = (e) => ({ className: "string", begin: "~?" + e + ".*?" + e }),
    ...
    grmr_rust: (e) => {
      ...
      return {
        ...
        contains: [
          ...
          {
            begin: e.IDENT_RE + "::",
            keywords: { keyword: "Self", built_in: i },
          },
